...
* 2 sub-modules containing configuration for classy paragraphs, for both 12 and 14 column grid systems.
...
3. Add a new entity reference revisions field to on of your entities and allow it to use ONLY the paragraphs Row paragraph type.
4.
