...
class Contact extends ContentEntityBase implements ContactInterface {
  ...
  public function getFoo() {
    return $this->get('departmets')->value;
  }
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    // Name field for the person.
    // We set display options for the view as well as the form.
    // Users with correct privileges can change the view and edit configuration.

    /* 1 */
    $fields['persimage'] = BaseFieldDefinition::create('image')
      ->setLabel(t('Image'))
    ...
    /* 2 */
    $fields['departmets'] = BaseFieldDefinition::create('entity_reference')
    ...
    /* 3 */
    $fields['short_info'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Short Info'))
      ->setDescription(t('Short info about person.'))
      ->setSettings(array(
        'default_value' => '',
        'max_length' => 255,
        'text_processing' => 0,
    ...
    $fields['title'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Title'))
      ->setDescription(t('The title of the Person entity.'))
      ->setSettings([
        'max_length' => 255,
        'text_processing' => 0,
      ])
